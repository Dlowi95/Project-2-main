...
@section('content')
    <div class="cart-success">
        <div class="panel-head">
            <h2 class="cart-heading"><span style="color: rgb(12, 185, 128)">Đặt hàng thành công</span></h2>
            <div class="discover-text"><a href="{{ write_url('san-pham') }}">Khám phá thêm các sản phẩm khác tại đây</a></div>
        </div>
        <div class="panel-body">
            <h2 class="cart-heading mt15"><span>Thông tin đơn hàng</span></h2>
                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            ...
                            <tr class="total_payment">
                                ...
                                <td style="color: red">{{ convert_price($order->cart['cartTotal'] - $order->promotion['discount'], true) }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
