            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="header-search">
                    <form action="{{ write_url('tim-kiem') }}" class="uk-form form">
                        <input type="text" name="keyword" value="" class="input-text" placeholder="Nhập tên thú cưng...">
                ...
                <div class="header-toolbox">
                    <div class="uk-flex uk-flex-middle">
                        ...
                        @if(Auth::guard('customer')->check())
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('customer.profile') }}">Trang cá nhân</a>
                        ...
                        @else
                            ...
                            <a href="{{ route('fe.auth.login') }}">
                                <div class="header-account">
                                    <button type="button"><i class="fa fa-user-o" aria-hidden="true"></i></button>
                                </div>
                            </a>
                        @endif
                    </div>
            ...
            <div class="uk-grid uk-grid-medium uk-flex uk-flex-middle">
                <div class="uk-width-large-1-5">
                    ...
                    <div class="categories">
                        <div class="category-heading">Danh mục thú cưng</div>
        ...
        <div class="uk-container uk-container-center">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <a href="#mobileCanvas" class="mobile-menu-button" data-uk-offcanvas>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1536 1896.0833" class="" fill="rgb(161, 172, 225)">
                    ...
                    <div class="uk-flex uk-flex-middle">
                        <a href="{{ write_url('thanh-toan') }}" class="btn btn-addCart">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                                <g>
                                    <path d="M24.4941 3.36652H4.73614L4.69414 3.01552C4.60819 2.28593 4.25753 1.61325 3.70863 1.12499C3.15974 0.636739 2.45077 0.366858 1.71614 0.366516L0.494141 0.366516V2.36652H1.71614C1.96107 2.36655 2.19748 2.45647 2.38051 2.61923C2.56355 2.78199 2.68048 3.00626 2.70914 3.24952L4.29414 16.7175C4.38009 17.4471 4.73076 18.1198 5.27965 18.608C5.82855 19.0963 6.53751 19.3662 7.27214 19.3665H20.4941V17.3665H7.27214C7.02705 17.3665 6.79052 17.2764 6.60747 17.1134C6.42441 16.9505 6.30757 16.7259 6.27914 16.4825L6.14814 15.3665H22.3301L24.4941 3.36652ZM20.6581 13.3665H5.91314L4.97214 5.36652H22.1011L20.6581 13.3665Z" fill="#7688de"></path>
                                    <path d="M7.49414 24.3665C8.59871 24.3665 9.49414 23.4711 9.49414 22.3665C9.49414 21.2619 8.59871 20.3665 7.49414 20.3665C6.38957 20.3665 5.49414 21.2619 5.49414 22.3665C5.49414 23.4711 6.38957 24.3665 7.49414 24.3665Z" fill="#7688de"></path>
                                    <path d="M17.4941 24.3665C18.5987 24.3665 19.4941 23.4711 19.4941 22.3665C19.4941 21.2619 18.5987 20.3665 17.4941 20.3665C16.3896 20.3665 15.4941 21.2619 15.4941 22.3665C15.4941 23.4711 16.3896 24.3665 17.4941 24.3665Z" fill="#7688de"></path>
                                </g>
                                <defs>
                                    <clipPath>
                        ...
                        @else
                            <!-- Khi người dùng chưa đăng nhập -->
                            <a href="{{ route('fe.auth.login') }}" class="login-mobile">
...
<div id="mobileCanvas" class="uk-offcanvas offcanvas">
    <div class="uk-offcanvas-bar">
        ...
        <ul class="l1 uk-nav uk-nav-offcanvas uk-nav-parent-icon mt10" data-uk-nav>
