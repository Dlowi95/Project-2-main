...
<body>
	...
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" action="{{ route('fe.auth.dologin') }}" method="POST">
                @csrf
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "Bạn chưa nhập Mật khẩu">
				...
				<div class="flex-c p-b-50">
					<a href="{{ route('auth.facebook') }}" class="login100-social-item">
						<i class="fa fa-facebook-f"></i>
					</a>

					<a href="{{ route('auth.google') }}" class="login100-social-item">
						<img src="{{ asset('frontend/resources/img/icon-google.png') }}" alt="GOOGLE">
					</a>
				</div>

				<div class="text-center">
					<a href="{{ route('customer.register') }}" class="txt2 hov1">
						Đăng Ký Ngay 
					</a>
					<i class="fa fa-arrows-h m-2" aria-hidden="true"></i>
                    <a href="{{ route('forgot.customer.password') }}" class="txt2 hov1">Quên Mật Khẩu</a>
				</div>
