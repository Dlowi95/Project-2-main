                ...
                <div class="uk-width-large-2-4">
                    <div class="panel-profile">
                        <div class="panel-head profile-header">
                            <h2 class="heading-2 profile-h2"><span>Hồ sơ của tôi</span></h2>
                        </div>
                        <div class="panel-body">
                            ...
                            <form action="{{ route('customer.profile.update') }}" method="post" class="uk-form uk-form-horizontal login-form profile-form">
                                @csrf
                                <div class="uk-form-row form-row mt20">
                                ...
                                <button type="submit" name="send" value="create" class="btn-save-profile">Lưu thông tin</button>
                            </form>
                        </div>
                    </div>
                </div>
