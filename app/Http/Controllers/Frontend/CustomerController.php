...
class CustomerController extends FrontendController
{
    ...
    public function profile(){
        ...
        $system = $this->system;
        $seo = [
            'meta_title' => 'Trang tài khoản khách hàng của'.$customer['name'],
            'meta_keyword' => '',
            'meta_description' => '',
            'meta_image' => '',
    ...
    public function updateProfile(EditProfileRequest $request){
        ...
        return redirect()->route('customer.profile')->with('error','Cập nhật hồ sơ không thành công. Hãy thử lại');
    }
    ...
    public function passwordForgot(){
        ...
        $system = $this->system;
        $seo = [
            'meta_title' => 'Trang thay đổi mật khẩu của'.$customer['name'],
            'meta_keyword' => '',
            'meta_description' => '',
            'meta_image' => '',
            'canonical' => route('customer.profile')
